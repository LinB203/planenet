...
from keras.layers import Activation, BatchNormalization, Add, Multiply, Reshape, Lambda
...
def MobileNetv3_small(input_shape,classes, standard_input):
    ...
    x = conv_block(x, 16, (3, 3), strides=(2, 2), nl='HS')
