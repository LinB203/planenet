...
def ShuffleNetV2(scale_factor=2, pooling='avg', standard_input=True,
                 input_shape=(224, 224, 3), num_shuffle_units=[3, 7, 3],
                 classes=1000):
    ...
    x = BatchNormalization(axis=-1, momentum=0.9, epsilon=1e-5, name='bn1')(x)
    x = Activation('relu', name='conv1_bn1_relu')(x)
    ...
    model = Model(inputs=img_input, outputs=x, name='ShuffleNet_V2')
