...
def MnasNet(n_classes=10, input_shape=(32, 32, 3), alpha=1.25, standard_input=True):
...
def MBConv_idskip(x_input, filters, kernel_size, strides=1, filters_multiplier=1, alpha=1.25):
