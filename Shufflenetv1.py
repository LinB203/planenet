...
from keras.layers import Activation, BatchNormalization, add, Reshape, DepthwiseConv2D, MaxPooling2D, Lambda
...
def ShuffleNetV1(input_shape, classes, standard_input):
    ...
    model = Model(img_input, predicts)
